...
class SlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slot" do
    assert_difference("Slot.count") do
      post slots_url, params: { slot: { department_id: @slot.department_id, end_time: @slot.end_time, start_time: @slot.start_time } }
    end
  ...
  test "should update slot" do
    patch slot_url(@slot), params: { slot: { department_id: @slot.department_id, end_time: @slot.end_time, start_time: @slot.start_time } }
